...
//
//  Listing: -   14.4 - Ampelsteuerung3.java  
//                      nutzt Thread und läuft dadurch
//                aber  erst durch Phasen vor stop 
//  
//   NetBeans Project
//
//    Autor: - Daniel dgtl
...
public class Ampelsteuerung3 extends javax.swing.JFrame implements Runnable {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ampelsteuerung3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ampelsteuerung3().setVisible(true);
            }
        });
    }
