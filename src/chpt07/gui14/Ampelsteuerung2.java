...
//
//  Listing: -   14.3 - Ampelsteuerung2.java
//                      mit paintImmediately  
...
public class Ampelsteuerung2 extends javax.swing.JFrame {
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        if (jCheckBox1.isSelected()) {
            ...
            while (jCheckBox1.isSelected()) {
                try {
                    jAmpel.setPhase(1);
                    jCheckBox1.paintImmediately
                        (0, 0, jCheckBox1.getWidth(), jCheckBox1.getHeight());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ampelsteuerung2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ampelsteuerung2().setVisible(true);
            }
        });
    }
