...
//
//  Listing: -   14.14 - AtariAnimation.java  
//
...
public class AtariAnimation extends JFrame {

    /**
     * Creates new form Ballanimation
     */
    public AtariAnimation() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtariAnimation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtariAnimation().setVisible(true);
            }
        });
    }
